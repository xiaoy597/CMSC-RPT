...
,SEC_CDE
,SEC_ACCT
,SUM(CASE WHEN TRAD_INDC = 'B' 
	THEN CAST(CAST(TRAD_VOL AS DECIMAL(28,3)) * TRAN_PRC * BUY_EXCH_RATE AS DECIMAL(18,2)) 
	ELSE CAST(0.00 AS DECIMAL(18,2)) END) AS BUY_AMT
,SUM(CASE WHEN TRAD_INDC = 'S' 
	THEN CAST(CAST(TRAD_VOL AS DECIMAL(28,3)) * TRAN_PRC * SAL_EXCH_RATE AS DECIMAL(18,2)) 
	ELSE CAST(0.00 AS DECIMAL(18,2)) END) AS SELL_AMT
...
SELECT 
  TRAD_DATE
  ,SHDR_ACCT
  ,SUM(CASE WHEN TRAD_VOL>0 
	THEN CAST(CAST(TRAD_VOL AS DECIMAL(28,3))*TRAN_PRC*EXCH_RT AS DECIMAL(18,2))
	ELSE CAST(0.00 AS DECIMAL(18,2)) END) AS BUY_AMT 
  ,SUM(CASE WHEN TRAD_VOL<0 
	THEN CAST(CAST(TRAD_VOL AS DECIMAL(28,3))*TRAN_PRC*EXCH_RT AS DECIMAL(18,2)) 
	ELSE CAST(0.00 AS DECIMAL(18,2)) END) AS SELL_AMT
